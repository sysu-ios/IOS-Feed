...
- (void)addBackViewWithCount:(NSInteger)count
{
    ...
    self.backView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, self.cbs_topHeight, self.width, self.height - self.cbs_buttonHeight - self.cbs_topHeight - rectStatus.size.height)];
...
{
    // topHeight
    self.headerView.frame = CGRectMake(0, self.cbs_topHeight, self.width, self.cbs_buttonHeight);
    ...
    for (NSInteger index = 0; index < titleArray.count; index++) {
        ...
        // ----
        //CGRectMake(self.width*index, self.cbs_NavTopHeight, self.width, self.height - self.cbs_buttonHeight)];
...
- (UIColor *)cbs_titleSelectedColor
{
    if (_cbs_titleSelectedColor == nil) {
        _cbs_titleSelectedColor = [UIColor colorWithRed:50 / 255.0 green: 144 / 255.0 blue:255 / 255.0 alpha:1];
    }
